...
<head>
  ...
  <!-- Higcharts CSS -->
  <link href="<?php echo base_url();?>vendor/highcharts/css/highcharts.css" rel="stylesheet">

  <!-- Higcharts JavaScript -->
  <script src="<?php echo base_url();?>vendor/highcharts/highcharts.js"></script>
  <script src="<?php echo base_url();?>vendor/highcharts/modules/exporting.js"></script>
  <script src="<?php echo base_url();?>vendor/highcharts/modules/export-data.js"></script>
  <script src="<?php echo base_url();?>vendor/highcharts/modules/accessibility.js"></script>
